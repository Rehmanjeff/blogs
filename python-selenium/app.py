...
def before_request_func():
    ...
    if request.endpoint in ['routes.read_blog', 'routes.update_blog', 'routes.list_blogs', 'routes.create_blog', 'routes.create_author', 'routes.update_author', 'routes.admin_dashboard', 'routes.list_authors', 'routes.create_category', 'routes.get_categories', 'routes.update_category']:
