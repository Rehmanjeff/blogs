                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    <div class="w-full mb-5">
                        <label for="name" class="block text-sm font-medium text-gray-700">Avatar</label>
                        <div>
                            <input class="hidden" ref="file" type="file" @change="updateAvatar" name="file" accept="image/*">
                            <div class="flex items-center gap-2 mt-2">
                              <img class="w-12 object-cover rounded-full" :src="edit && edit.image ? `/assets/authors/${edit.image}` : avatarSource" />
                    ...
                    <div class="w-full mb-5">
                        ...
                        <input type="text" v-model="name" autocomplete="name" class="mt-1 border border-gray-300 rounded-sm h-10 w-full block pl-2 text-gray-500 text-sm" />
                    </div>
                    <div class="flex">
...
let avatarSource = ref('/assets/default.png')
const name = ref('')
